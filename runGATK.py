...
def main() :
    ...
    gen.add_argument('-a', '--all-sites',               action="store_true", help="Do not use allsites option in GenotypeGVCFs (in addition to normal vcf output). Default: will output allsites vcf and normal vcf output.")
    ...
    gen.add_argument('-l','--log',                      action="store_true", help="Output sub files log of HaplotypeCaller, useful for debugging. Default: %(default)s")
