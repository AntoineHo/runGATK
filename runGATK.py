...
def main() :
    ...
    cal.add_argument('-pim', '--pcr-indel-model',nargs=1,type=str,default=['NONE'],choices=["NONE","CONSERVATIVE","HOSTILE","AGGRESSIVE"],help="<STRING> Argument to pass to HaplotypeCaller --pcr-indel-model. Default: NONE")
    ...
    cal.add_argument('-he','--heterozygosity',nargs=1,type=float,default=[0.01], required=False,help="<FLOAT> Heterozygosity value to pass to HaplotypeCaller. Default: 0.01")
